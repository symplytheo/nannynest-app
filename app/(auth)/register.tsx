...
export default function RegisterScreen() {
  ...
  const isNanny = params.type === "nanny";
  ...
  const onSubmit = async (data: RegisterFormData) => {
    ...
    try {
      ...
      router.push(`/(auth)/verify-email?type=registration&userType=${params.type}` as any);
    } catch (error) {
  ...
  return (
    ...
    >
      ...
      >
        {/* Header */}
        <AuthHeader title={`Create a ${isNanny ? "Nanny" : "Client"} Account`} />
